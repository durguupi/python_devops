...
print(os.stat('/mnt/g/newyear_2021/python-devops/os_module/basics/basic.py'))

# This jus prints the size of the file in bytes
print(os.stat('/mnt/g/newyear_2021/python-devops/os_module/basics/basic.py').st_size)

# Prints out the last modification time
print(os.stat('/mnt/g/newyear_2021/python-devops/os_module/basics/basic.py').st_mtime)
